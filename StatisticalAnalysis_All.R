...
ggplot(dayBinTAB, aes(x=tbin,y=HoursProp))+
  ...
  geom_line()+
  geom_point()
fig1 =paste("E:/Project Sites/",site,"/Seasonality/",site,"HoursProp_TimeSeries.png",sep="")
ggsave(fig1)
...
fig2 =paste("E:/Project Sites/",site,"/Seasonality/",site,"BoxPlot.png",sep="")
ggsave(fig2)
...
ggplot(GroupedDay, aes(x=tbin,y=HoursProp))+
  ...
  geom_line()+
  geom_point()
fig1 =paste("E:/Project Sites/",site,"/Seasonality/",site,"HoursProp_TimeSeriesITS.png",sep="")
ggsave(fig1)

##### grouped data by day of year - mean
filename2 = paste("E:/Project Sites/",site,"/Seasonality/",site,"_days365GroupedMean_forGLMR125.csv",sep="")
...
ggplot(oneyear, aes(x=Day,y=HoursProp))+
  ...
  geom_line()+
  geom_point()
fig4 =paste("E:/Project Sites/",site,"/Seasonality/",site,"AveragedHoursProp_TimeSeries.png",sep="")
ggsave(fig4)
...
ggplot(GroupedYear, aes(x=Day,y=HoursProp))+
  ...
  geom_line()+
  geom_point()
fig4 =paste("E:/Project Sites/",site,"/Seasonality/",site,"AveragedHoursProp_TimeSeriesITS.png",sep="")
ggsave(fig4)
...
ggplot(oneyear, aes(x=Day,y=HoursProp))+
  ...
  geom_line()+
  geom_point()
fig5 =paste("E:/Project Sites/",site,"/Seasonality/",site,"AveragedHoursProp_TimeSeries_ErrorBars.png",sep="")
ggsave(fig5)
}else{}
...
print(vizGG,pages =1)
fig6 =paste("E:/Project Sites/",site,"/Seasonality/",site,"GAM1.png",sep="")
ggsave(fig6)
...
fig7 =paste("E:/Project Sites/",site,"/Seasonality/",site,"GAM2.png",sep="")
ggsave(fig7)
